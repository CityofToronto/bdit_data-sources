...
-- count how many bins there are per day
    ...
    WHERE 
        datetime_bin >= '2020-01-01' 
        AND datetime_bin < '2023-04-01'
    GROUP BY 
        v.arterycode,
        v.detector_id,
        date_trunc('day', v.datetime_bin)::date
    HAVING COUNT (datetime_bin) = 96 -- 96 is a perfect day of data; coming soon: look at time gaps because we can fill some and have more data days
    )
