...
GRANT EXECUTE ON FUNCTION miovision_api.aggregate_15_min_mvt(date, date, integer []) TO miovision_api_bot;

GRANT EXECUTE ON FUNCTION miovision_api.aggregate_15_min_mvt(date, date, integer []) TO miovision_admins;
