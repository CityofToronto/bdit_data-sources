...
| classification_uid | the classification; `NULL` if applies to all classifications e.g. a badly misaligned camera. **Note:** if classification_uid = 1 (lights), all vehicle types are excluded from filtered views (see [#1340](https://github.com/CityofToronto/bdit_data-sources/issues/1340))  |
...
#### `centreline_miovision` - Known Issues
