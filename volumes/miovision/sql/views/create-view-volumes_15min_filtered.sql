CREATE OR REPLACE VIEW gwolofs.miovision_15min_test_filtered AS (
    SELECT
...
COMMENT ON VIEW gwolofs.miovision_15min_test_filtered IS E''
...
and only common (>0.05%) intersection movements included.';

GRANT SELECT ON TABLE gwolofs.miovision_15min_test_filtered TO bdit_humans;