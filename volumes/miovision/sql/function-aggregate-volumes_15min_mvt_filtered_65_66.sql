...
WITH zero_padding_movements AS (
	...
	WHERE intersection_uid IN (65, 66) AND datetime_bin15> mai.date_installed + INTERVAL '1 day' AND (mai.date_decommissioned IS NULL OR (datetime_bin15< mai.date_decommissioned - INTERVAL '1 day'))
), aggregate_insert AS (
