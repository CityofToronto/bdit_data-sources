...
CREATE TABLE miovision_api.anomalous_ranges (
    ...
    notes text,
    investigation_level text NOT NULL REFERENCES miovision_api.qa_investigation_levels (uid),
    problem_level text NOT NULL REFERENCES miovision_api.qa_problem_levels (uid),
