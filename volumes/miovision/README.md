...
You can see the current locations of Miovision cameras [on this map.](https://github.com/CityofToronto/bdit_data-sources/blob/master/volumes/miovision/geojson/mio_intersections.geojson)
