...
| flow_geom           | USER-DEFINED | 0102000020E6100000020000004EB43D5A70DA53C081462E0B17D54540C5DD408F71DA53C0BAD16D8616D54540 | A two-node line, where the first node indicates the position of the sensor and the second indicates the normal direction of travel over that sensor relative to the first node. I.e. the line segment is an arrow pointing in the direction of travel. |
