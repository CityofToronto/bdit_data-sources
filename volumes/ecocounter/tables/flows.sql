...
ALTER TABLE gwolofs.flows OWNER TO ecocounter_admins;

REVOKE ALL ON TABLE gwolofs.flows FROM aduyves;
REVOKE ALL ON TABLE gwolofs.flows FROM bdit_humans;
REVOKE ALL ON TABLE gwolofs.flows FROM ecocounter_bot;

GRANT UPDATE ON TABLE gwolofs.flows TO aduyves;

GRANT SELECT ON TABLE gwolofs.flows TO bdit_humans;

GRANT ALL ON TABLE gwolofs.flows TO ecocounter_admins;

GRANT SELECT, INSERT ON TABLE gwolofs.flows TO ecocounter_bot;

COMMENT ON TABLE gwolofs.flows
...
COMMENT ON COLUMN gwolofs.flows.bin_size
IS 'temporal bins are either 15, 30, or 60 minutes, depending on the sensor';

COMMENT ON COLUMN gwolofs.flows.flow_geom
...
COMMENT ON COLUMN gwolofs.flows.includes_contraflow
