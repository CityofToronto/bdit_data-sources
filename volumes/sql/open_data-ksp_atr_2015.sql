...
regexp_REPLACE(fromstreet.intersec5, '(King St W / )|(King St E / )|( / King St W)', '', 'g') ||' to '|| regexp_replace(tostreet.intersec5, '(King St W / )|( / King St W)', '', 'g') from_to, 
...
WHERE lf_name = 'King St W' AND count_type = 1
);
