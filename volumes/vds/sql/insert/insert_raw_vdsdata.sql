...
INSERT INTO vds.last_active AS existing (
...
DO UPDATE SET
first_active = LEAST(MIN(inserted.dt), existing.first_active),
last_active = GREATEST(MAX(inserted.dt), existing.last_active);