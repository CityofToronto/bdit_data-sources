--Aggregate `vds.raw_vdsvehicledata` into table `vds.veh_length_15min` by detector / 15min bins / MTO length bins.
INSERT INTO vds.veh_length_15min (division_id, vdsconfig_uid, entity_location_uid, datetime_15min, mto_class_uid, count, total_count)
...
LEFT JOIN traffic.mto_length_bin_classification mto ON v.length_meter::numeric <@ mto.length_range
WHERE
