--Builds citywide daily congestion metrics by aggregating segment-level tti
...
CREATE TABLE sborjia.citywide_daily_weighted_length_here_2024_dynamic AS
WITH base AS (
  SELECT
    f.segment_id,
    f.dt,
...
SELECT
  ...
  )::numeric, 3) AS citywide_tti_pre2020_hw25_nonhw10_post2020_roll6,
  ...
  )::numeric, 3) AS citywide_tti_pre2020_2021ff_post2020_roll6
