...
CREATE TABLE ttc_trips (
	...
	orig_geom geometry(LINESTRING,3857),	-- geometry of all points
	...
	-- debugging fields
	match_geom geometry(MULTILINESTRING,3857), -- map-matched route geometry
	clean_geom geometry(LINESTRING,3857), -- geometry of points used in map matching
