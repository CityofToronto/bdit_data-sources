-- View: here_agg.segment_travel_times_monthly_view

-- DROP VIEW here_agg.segment_travel_times_monthly_view;

CREATE OR REPLACE VIEW here_agg.segment_travel_times_monthly_view AS
SELECT
    sbm.segment_id,
    cc.streetname,
...
FROM here_agg.segment_travel_times_monthly sbm
...
ALTER TABLE here_agg.segment_travel_times_monthly_view
OWNER TO here_admins;

GRANT SELECT ON TABLE here_agg.segment_travel_times_monthly_view TO bdit_humans;
GRANT ALL ON TABLE here_agg.segment_travel_times_monthly_view TO here_admins;
