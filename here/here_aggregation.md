...
WHERE
    (
        ta.tx >= '2019-01-01 00:00:00'::timestamp
        AND ta.tx < '2019-02-18 00:00:00'::timestamp 
    ) 
...
WHERE 
   ( -- define date range
      tx >= '2019-01-01 00:00:00'::timestamp
      AND tx < '2019-02-18 00:00:00'::timestamp
   )
   AND tx::time <@ time_ranges.time_range 
