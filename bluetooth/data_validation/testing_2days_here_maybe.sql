...
--Create view for that of here (lookup table still not sure yet, MAYBE)
CREATE MATERIALIZED VIEW jchew.here_top10_2days_maybe AS
...
FROM jchew.validation_bt_here_maybe bt
...
--ratio for here
CREATE OR REPLACE VIEW jchew.ratio_here_top10_2days_maybe AS
WITH X AS (
SELECT a.analysis_id AS analysis_id_1, 
	...
	FROM jchew.here_top10_2days_maybe a
JOIN jchew.here_top10_2days_maybe b
...
RIGHT JOIN jchew.ratio_here_top10_2days_maybe b
USING (analysis_id_1)