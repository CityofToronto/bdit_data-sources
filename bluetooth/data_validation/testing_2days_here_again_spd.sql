--Create view for that of here spd (after re-routing is done, AGAIN)
CREATE OR REPLACE VIEW jchew.here_top10_2days_again_spd AS 
...
--ratio for here spd
CREATE OR REPLACE VIEW jchew.ratio_here_top10_2days_again_spd AS
WITH X AS (
SELECT a.analysis_id AS analysis_id_1,
	...
	FROM jchew.here_top10_2days_again_spd a
JOIN jchew.here_top10_2days_again_spd b
...
RIGHT JOIN jchew.ratio_here_top10_2days_again_spd b
USING (analysis_id_1)