...
dag = DAG(dag_id = dag_name, default_args = default_args, schedule_interval = ' 30 14 * * * ')
#Every day at 1630
...
pull_data = BashOperator(
        task_id = 'pull_here',
        bash_command = '/data/airflow/airflow_venv/bin/python3 /data/airflow/dev_scripts/here/traffic/here_api.py -d /data/airflow/dev_scripts/here/traffic/config.cfg -s {{ yesterday_ds_nodash }} -e {{ yesterday_ds_nodash }} ', 
        dag=dag,
        )
