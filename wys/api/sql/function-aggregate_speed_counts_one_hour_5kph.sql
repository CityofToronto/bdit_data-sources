...
BEGIN
	...
	FROM insert_data B
	WHERE A.speed_count_uid IS NULL
...
ALTER FUNCTION wys.aggregate_speed_counts_one_hour_5kph()
    OWNER TO rdumas;

GRANT EXECUTE ON FUNCTION wys.aggregate_speed_counts_one_hour_5kph() TO dbadmin;

GRANT EXECUTE ON FUNCTION wys.aggregate_speed_counts_one_hour_5kph() TO wys_bot;

REVOKE EXECUTE ON FUNCTION wys.aggregate_speed_counts_one_hour_5kph() FROM PUBLIC;
