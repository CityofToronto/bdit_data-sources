...
# insert into gis.{} as a {} select {} from gis._{} on conflict({}) 
# do update set {} = {} where a.{} <> Excluded.{}; 
# comment on table gis.{} is 'last updated: {}'".format(output_table, insert_column, 
# (insert_column[:-1])[1:], output_table, primary_key, insert_column,excluded_column,where_id, where_id, output_table, date)
